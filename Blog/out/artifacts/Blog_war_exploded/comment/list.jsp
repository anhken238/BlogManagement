        ...
        <c:forEach items='${requestScope["comments"]}' var="comment">
            <tr>
                ...
                <td><a href="/comments?action=edit&id=${comment.getId()}"> Edit </a>|
                    <a href="/comments?action=delete&id=${comment.getId()}" onclick="return confirm('Are you sure you want to delete?')"> Delete </a></td>
            </tr>
        </c:forEach>
    </table>
</form>
<form method="post" action="/comments?action=listByIdUserOrPost">
    <h3>Enter the ID POST you want to see comment list</h3>
    <input style="margin-left: 16px " type="text" id="viewByIdPost" name="viewByIdPost" placeholder="Search comment by user name or title of post" required >
    <input type="submit" value="Search comments"><br>
</form>
</body>
</html>
