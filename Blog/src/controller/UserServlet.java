...
public class UserServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request, HttpServletResponse response) throws NoSuchAlgorithmException {
        ...
        String userNameSession = String.valueOf(session.getAttribute("Admin"));
        session.setAttribute("Admin", userNameSession);
        if(userNameSession!= null){
            User userSession = userImpl.getUserByUsername(userNameSession);
            ...
            if(userSession.getRole().equals(roleAdmin)){
