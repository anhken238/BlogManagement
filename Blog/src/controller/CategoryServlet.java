...
//    }
    ...
    private void updateCategory(HttpServletRequest request, HttpServletResponse response) {
        String nameCategory = request.getParameter("nameCategory");
            ...
            String message = "Category information was updated";
        try {
            response.sendRedirect("categories?message=" + URLEncoder.encode(message, "UTF-8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        RequestDispatcher dispatcher = request.getRequestDispatcher("category/create.jsp");
        ...
        this.categoryImpl.createCategory(category);
            String message = "Create category was success";
        try {
            response.sendRedirect("categories?message=" + URLEncoder.encode(message, "UTF-8"));
        } catch (IOException e) {
            e.printStackTrace();
...
//        request.setAttribute("category", category);
        this.categoryImpl.deleteCategory(category);
        try {
            String message = "category was deleted";
            response.sendRedirect("categories?message=" + URLEncoder.encode(message, "UTF-8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
