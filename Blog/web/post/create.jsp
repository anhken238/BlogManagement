...
<form method="post" enctype ="multipart/form-data">
    <fieldset>
        ...
        <table>
            <tr>
                <td>Title</td>
                <td><input type="text" name="title" id="title"  style="width: 1080px; height: 40px"></td>            </tr>
            <tr>
                <td>Introduce </td>
                <%--<td><textarea rows="4" cols="100" name="introduce" id="introduce"></textarea></td>--%>
                <td><textarea rows="" cols="" name="introduce" id="introduce" style="width: 1080px; height: 680px"></textarea></td>
            </tr>
            <tr>
                <td>Content </td>
                <td><textarea rows="" cols="" name="content" id="content" style="width: 1080px; height: 680px"></textarea></td>
            </tr>
            <tr>
                <td>Image </td>
