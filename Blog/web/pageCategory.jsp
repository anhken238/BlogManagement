...
<%
    ...
    int id = (int) request.getAttribute("idCategory");
    List<Post> listPost = postDao.getPostByCategory(id);
    int start =0, end = 2;
    if(listPost.size() < 2){
        end = listPost.size();
    }
...
<div class="main">
    ...
    <div class="content">
        <div class="content_resize">
            <div class="mainbar">
                <%--<c:if test='${requestScope["updating"] != null}'>--%>
                    <%--<span class="message">${requestScope["updating"]}</span>--%>
                <%--</c:if>--%>
                <% for(Post p : list){%>
                <div class="article">
